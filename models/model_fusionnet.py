...
class FusionNet(ShopBenchBaseModel):
    def __init__(self):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('./models/Truthful_DPO_TomGrc_FusionNet_7Bx2_MoE_13B/', trust_remote_code=True)
        self.model = AutoModelForCausalLM.from_pretrained('./models/Truthful_DPO_TomGrc_FusionNet_7Bx2_MoE_13B/', device_map='auto', torch_dtype=torch.float16, trust_remote_code=True, do_sample=True)
