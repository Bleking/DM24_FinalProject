...
class Falcon40B(ShopBenchBaseModel):
    def __init__(self):
        random.seed(AICROWD_RUN_SEED)

        model_path = 'tiiuae/falcon-40b'

        self.tokenizer = AutoTokenizer.from_pretrained('./models/falcon-40b/', trust_remote_code=True)
        self.model = AutoGPTQForCausalLM.from_pretrained('./models/falcon-40b/', quantize_config=None, device_map='auto', torch_dtype='auto', trust_remote_code=True, do_sample=True)
