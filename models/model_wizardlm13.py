...
class WizardLM13(ShopBenchBaseModel):
    def __init__(self):
        random.seed(AICROWD_RUN_SEED)

        model_path = 'WizardLMTeam/WizardLM-13B-V1.0'

        self.tokenizer = AutoTokenizer.from_pretrained('./models/WizardLM-13B-V1.0/', trust_remote_code=True)
        self.model = AutoGPTQForCausalLM.from_pretrained('./models/WizardLM-13B-V1.0/', quantize_config=None, device_map='auto', torch_dtype=torch.float16, trust_remote_code=True, do_sample=True)
