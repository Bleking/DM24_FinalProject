...
class Llama(ShopBenchBaseModel):
    def __init__(self):
        ...
        self.model = AutoModelForCausalLM.from_pretrained('./models/Meta-Llama-3-8B-Instruct/', device_map='auto', torch_dtype=torch.float32, trust_remote_code=True, do_sample=True)
